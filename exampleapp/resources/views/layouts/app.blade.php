...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ $user->role === 'school_admin' ? route('admin.dashboard') : ($user->role === 'staff' ? route('staff.dashboard') : route('student.dashboard')) }}">
